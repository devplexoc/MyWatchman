...
public class UserAddAdapter extends RecyclerView.Adapter<UserAddAdapter.MyviewHolder> {
    ...
    public interface SubuserEdit {
        void getSubuserData(int Id,String firstName, String lastName, String mobileNumber,String password);
    }
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.edit:
                                subuserEdit.getSubuserData(userlist.get(position).Id,userlist.get(position).FirstName,userlist.get(position).LastName,userlist.get(position).Mobile,userlist.get(position).Password);
                                break;
                            case R.id.delete:
