...
import com.plexoc.myapplication.Utils.DirectionsJSONParser;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng origin = new LatLng(6.3167079,-10.805942);
        LatLng dest = new LatLng(6.2903214,-10.7823624);
        ...
        mMap.addMarker(new MarkerOptions().position(dest).title("Customer"));
