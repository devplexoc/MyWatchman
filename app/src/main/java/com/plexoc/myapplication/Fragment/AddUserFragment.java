...
import com.plexoc.myapplication.Adapter.UserAddAdapter;
...
import com.plexoc.myapplication.Model.UserAddModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                replaceFragment(new AddUserFormFragment(0, null, null, null,null), null);
            }
        });
            ...
            public void onResponse(Call<ListResponse<User>> call, Response<ListResponse<User>> response) {
                if (response.isSuccessful()) {
                    if (!response.body().Values.isEmpty()) {
                        ...
                        userAddAdapter = new UserAddAdapter(response.body().Values, getContext(), (Id, firstName, lastName, mobileNumber,password) -> {
                            replaceFragment(new AddUserFormFragment(Id, firstName, lastName, mobileNumber,password), null);
                        }, Id -> {
                            //Id = user.CustomerId;
                            getSubUserDelete(Id);
                        },(Id, Password) -> {
